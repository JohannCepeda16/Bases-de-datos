...
/*Diseñe la estructura y las restricciones declarativas del CRUD Registrar Solicitud de Viaje
(modelo físico de datos). Implemente las restricciones definidas. Construya también las
restricciones adicionales necesarias para la ejecución.*/
